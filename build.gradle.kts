...
dependencies {
	...
	modImplementation("dev.onyxstudios.cardinal-components-api:cardinal-components-chunk:$ccaVersion")
	...
	include("dev.onyxstudios.cardinal-components-api:cardinal-components-chunk:$ccaVersion")
